    ...
    return (
        ...
        >
            <motion.div className="relative transform-3d w-full max-w-4xl" style={{ rotateX, rotateY }}>
                <motion.img src="../../public/assets/hero_img.png"
                    className=" border bg-linear-180 from-cyan-700 to-transparent p-1 w-full rounded-[15px] will-change-transform transform-[translateZ(0)]"
